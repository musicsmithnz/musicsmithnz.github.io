...
*/
var ipfs_index_template_url="https://ipfs.io/ipfs/QmaCRqMHQm7D6sWoaEzNWFkRPiq7suschxZvq9QZQetfSt/index.html"
...
function writeFile(file_name, file_body){
	...
	fs.writeFile(file_name, file_body,"utf-8", function(err) {
        ...
        console.log("first afterlife")
        return
        console.log("second afterlife")
	}) 
}
function insertString( inputString, insertString, atString){
	console.log("atString: " + atString)
	var modifiedString = inputString.toString().replace(new RegExp(atString,'g'),atString + "\n\t\t\t" + insertString)
